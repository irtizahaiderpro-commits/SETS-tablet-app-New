      ...
      <div className="mx-auto flex min-h-[100svh] max-w-[1380px] flex-col overflow-hidden border border-white/60 bg-[#F5F8FC] shadow-[0_28px_90px_rgba(11,31,58,0.18)] sm:h-[93vh] sm:min-h-0 sm:rounded-[38px]">
        ...
        {screen === "dashboard" && (
          <>
            ...
            />
            <div className="grid min-h-0 flex-1 grid-cols-1 overflow-auto bg-[#F4F7FB] xl:grid-cols-[236px_1fr] xl:overflow-hidden">
              <DashboardSidebar
                active="dashboard"
                demoMode={demoMode}
              ...
              <div className="flex h-full min-h-0 flex-col gap-4 overflow-visible p-3 sm:p-4 lg:p-5 xl:overflow-hidden">
                <div className="grid shrink-0 gap-2 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-6">
                  {[
                    ...
                    <button
                      ...
                      className="h-[72px] rounded-lg border border-[#DDE6F0] bg-white px-3 py-2 text-left shadow-sm transition hover:-translate-y-0.5 hover:shadow-md"
                    >
                ...
                <div className="grid min-h-0 flex-1 grid-rows-[1.08fr_0.92fr] gap-4">
                  <SectionCard className="flex min-h-0 flex-col overflow-hidden rounded-2xl p-6">
                    <h2 className="mb-3 shrink-0 text-[26px] font-black tracking-wide text-[#0B1220]">
                      Tanks by Status
                    </h2>
                    <div className="grid min-h-0 flex-1 items-center gap-6 lg:grid-cols-[1.05fr_1.1fr]">
                      <div className="relative min-h-[220px] sm:h-full sm:min-h-[250px]">
                        ...
                        {dashboardStatusSplit.map((item) => {
                          ...
                          return (
                            <div key={item.name} className="grid items-center gap-3 sm:grid-cols-[32px_1fr_140px] sm:gap-4">
                              ...
                              />
                              <span className="text-2xl font-semibold tracking-wide text-[#0B1220]">
                                {item.name}
                              </span>
                              <span className="text-right text-2xl font-semibold tracking-wide text-[#0B1220]">
                                {item.value} ({percent}%)
                              </span>
                            </div>
                          );
                  ...
                  <SectionCard className="flex min-h-0 flex-col overflow-hidden rounded-2xl p-6">
                    <h2 className="mb-2 shrink-0 text-[26px] font-black tracking-wide text-[#0B1220]">
                      ...
                      <ResponsiveContainer width="100%" height="100%">
                        ...
                        >
                          ...
                          <XAxis
                            ...
                            tickLine={false}
                            tick={{ fontSize: 18, fontWeight: 500, fill: "#111827" }}
                          />
                          <YAxis
                            domain={[0, 100]}
